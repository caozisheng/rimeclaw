...
#define RC_DEFER_CONCAT_IMPL(a, b) a##b
#define RC_DEFER_CONCAT(a, b) RC_DEFER_CONCAT_IMPL(a, b)
#define DEFER(code)                               \
  auto RC_DEFER_CONCAT(_defer_guard_, __LINE__) = \
      ::rimeclaw::MakeDefer([&]() noexcept { code; })
